 ...
 */
public class Critter extends Actor1
{
    /**
    ...
    public void act()
    {
        if (getGrid() == null)
            return;
        ArrayList<Actor1> actors = getActors();
     ...
     */
    public ArrayList<Actor1> getActors()
    {
     ...
     */
    public void processActors(ArrayList<Actor1> actors)
    {
        for (Actor1 a : actors)
        {
